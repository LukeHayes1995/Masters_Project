...
public class Datacenter extends SimEntity {
	...
	public void processEvent(SimEvent ev) {
		...
		// Resource characteristics inquiry
			...
			case CloudSimTags.VM_MIGRATE_UNDER:
				processVmMigrateUnder(ev, false);
				break;
	...
	protected void processVmMigrate(SimEvent ev, boolean ack) {
		...
		//WE KNOW FOR SURE IT COMES IN HERE 
		...
		//HERE WE CAN CALL THE UPDATE STEP TO UPDATE THE Q VALUE 
	 ...
	 * @post $none
	 */
	protected void processVmMigrateUnder(SimEvent ev, boolean ack) {
	...
	protected void updateCloudletProcessing() {
		...
		Log.printLine("This must be called NON POWER - DATACENTER");
...
/*
	...
	private void setPowerVmSelectionPolicy(PowerVmSelectionPolicy vmSelectionPolicy) {
		this.vmSelectionPolicy = vmSelectionPolicy;
	}
	
	private PowerVmSelectionPolicy getPowerVmSelectionPolicy() {
