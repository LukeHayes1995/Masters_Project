...
public class Helper {
	...
	public static List<Object> printStatistics(
		...
		// 2) The current number of SLAV's in the last number of timesteps 
		...
		//This is the overall SLA Violations
		Map<String, Double> slaMetrics = getSlaMetrics(vms);
		double slaOverall = slaMetrics.get("overall");
		
		//This is the number of migrations
		int numberOfMigrations = datacenter.getMigrationCount();

		//Create a list of objects so we can put these statistics into one list and return it
		List<Object> statistics = new ArrayList<Object>();
		
		//Add the information to the list
		statistics.add(energy);
		statistics.add(slaOverall);
		statistics.add(numberOfMigrations);
